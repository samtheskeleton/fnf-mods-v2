...
function onCreatePost() 
  if not seenCutscene and isStoryMode then
   ...
   setProperty('white.alpha',0.3)
    ...
    addAnimationByPrefix('bfDialogue', 'neutral', 'BF_normal', 0, 70, false);
    ...
    makeAnimatedLuaSprite('purpledialogue', 'dialogueV4/purple', 200,170);
    addAnimationByPrefix('purpledialogue', 'mad', 'what', 24, false);
    ...
    setProperty('purpledialogue.visible',false)
...
function onTimerCompleted(tag)
    ...
    bfTalk = true   
    anim = 'happy'
    texto="That battle was amazing!"
end

if tag == 'dialogue2' then 
    bfTalk = true   
    anim = 'laugh'
    texto="My name is Boyfriend."
...
if tag == 'dialogue4' then 
    ...
    purpleTalk = true   
    anim = 'mad'
    texto="So you're boyfriend huh?"
    setProperty('purpledialogue.offset.x',150)
    ...
    purpleTalk = true 
    anim = 'angry'
    setProperty('purpledialogue.offset.x',58)
    objectPlayAnimation('purpledialogue', 'angry', false);
    runTimer('holaTexto', 0.0005)
    texto="I've been looking for you for a long time."      
end

...
don't.;
You've done this to me three times && each time you've done it.;
I've stated my disapproval, && yet you've somehow fucked it up each time.;
You **DO NOT** have my permission to reupload this mod onto any site, || download.;
Credit is !enough, you're profiting off me.;
Fuck off.;
...
Porting it over may !work very well, due to some scripts n' shit making videos render mid-song.;
...
its bad, im !very good, && frankly, this is all held together by spit && bandages.;
feel free to do whatever the fuck u want duh;
i just fucking hate website ports they're so fucking low effort && scummy;
assholes;
...
if(walk == true){
	...
	if(getProperty('boyfriend.animation.curAnim.name') == 'idle'){
	...
	}else if(getProperty('boyfriend.animation.curAnim.name') ~= 'idle'){
	...
	if(bfLegFrame == 0 && getProperty('boyfriend.animation.curAnim.name') ~= 'idle'){
		setProperty('boyfriend.y', 484);
	}
	if(bfLegFrame == 1 && getProperty('boyfriend.animation.curAnim.name') ~= 'idle'){
		setProperty('boyfriend.y', 480);
	}
	if(bfLegFrame == 2 && getProperty('boyfriend.animation.curAnim.name') ~= 'idle'){
		setProperty('boyfriend.y', 476);
	}
	if(bfLegFrame == 3 && getProperty('boyfriend.animation.curAnim.name') ~= 'idle'){
		setProperty('boyfriend.y', 480);
	}
	if(bfLegFrame == 4 && getProperty('boyfriend.animation.curAnim.name') ~= 'idle'){
		setProperty('boyfriend.y', 484);
	}
	if(bfLegFrame == 5 && getProperty('boyfriend.animation.curAnim.name') ~= 'idle'){
		setProperty('boyfriend.y', 480);
	}
	if(bfLegFrame == 6 && getProperty('boyfriend.animation.curAnim.name') ~= 'idle'){
		setProperty('boyfriend.y', 476);
	}
	if(bfLegFrame == 7 && getProperty('boyfriend.animation.curAnim.name') ~= 'idle'){
		setProperty('boyfriend.y', 480);
	}
	if(getProperty('boyfriend.animation.curAnim.name') == 'idle'){
    ...
    if(getProperty("bflegs.visible") == true){
        if(bfLegFrame == 0){
            setProperty("gf.offset.y", 4);
            setProperty("gf.offset.x", 4);
        }else if(bfLegFrame == 1){
            setProperty("gf.offset.y", 0);
            setProperty("gf.offset.x", 0);
        }else if(bfLegFrame == 2){
            setProperty("gf.offset.y", -4);
            setProperty("gf.offset.x", -4);
        }else if(bfLegFrame == 3){
            setProperty("gf.offset.y", 4);
            setProperty("gf.offset.x", 4);
        }else if(bfLegFrame == 4){
            setProperty("gf.offset.y", 0);
            setProperty("gf.offset.x", 0);
        }else if(bfLegFrame == 5){
            setProperty("gf.offset.y", -4);
            setProperty("gf.offset.x", -4);
        }
    }
	...
	if(getProperty('gf.animation.curAnim.name') == 'idle'){
		setProperty('bflegs.visible', false);
	}else{
		setProperty('bflegs.visible', true);
	}
	if(currentbg == 'island-fire'){
	...
	}else if(currentbg == 'island-fire2'){
		setProperty('redfilter.alpha', 0.1);
		setProperty('floor.alpha', 1);
		setProperty('floor2.alpha', 1);
		setProperty('floor3.alpha', 1);
	...
	if(curStep >= 1 && lowendsave1 == false){
		lowendsave1 = true;
		if(widescreen == false){
	...
	if(curStep >= 30 && lowendsave2 == false){
		lowendsave2 = true;
	    for i = 4,7 do;
            setPropertyFromGroup('strumLineNotes', i, 'alpha', 0);
        }
	...
	if(curStep >= 31 && lowendsave3 == false){
		lowendsave3 = true;
		doTweenAlpha('blackfade', 'blackfull', 0, 0.5, 'quadOut');
	}
	if(curStep >= 39 && lowendsave4 == false){
		lowendsave4 = true;
	...
	if(curStep >= 45 && lowendsave5 == false){
		lowendsave5 = true;
		doTweenX('backscroll', 'back', -512*3, 4*scrspd, 'linear');
		doTweenX('backscroll2', 'back2', -1024*3, 4*scrspd, 'linear');
		doTweenX('backscroll3', 'back3', 0, 4*scrspd, 'linear');
	...
	if(curStep >= 114 && lowendsave6 == false){
		lowendsave6 = true;
	    for i = 4,7 do;

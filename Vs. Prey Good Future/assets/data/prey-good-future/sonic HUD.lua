...
function onCreate()
    ...
    makeLuaSprite('sonicMissesSprite','sonicUI/sonic3/misses',textX,textY)
    ...
    makeLuaSprite('sonicTimeSprite','sonicUI/sonic3/time',textX,textY + ofs)
    setProperty('sonicTimeSprite.antialiasing',false)
    scaleObject('sonicTimeSprite',3.5,3.5)
    setObjectCamera('sonicTimeSprite','hud')

    makeLuaSprite('sonicScoreSprite','sonicUI/sonic3/score',textX,textY + (ofs * 2))
